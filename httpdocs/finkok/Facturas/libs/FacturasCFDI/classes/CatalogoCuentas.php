...
class CatalogoCuentas{
	...
	public function __construct($datos = array()){
		...
		$this->root = $this->xml->createElement('catalogocuentas:Catalogo');
	...
	public function createXML(){
		$this->addNamespaces();
		$contenido = "FacturasCFDI\Addendas\CatalogoCuentas";
	...
	protected function addNamespaces(){
		...
		$this->addAtt(
			array('key'=>"xmlns:catalogocuentas",'value'=>"www.sat.gob.mx/esquemas/ContabilidadE/1_1/CatalogoCuentas")
			);
		$this->addAtt(
			array('key'=>"xsi:schemaLocation",'value'=>"www.sat.gob.mx/esquemas/ContabilidadE/1_1/CatalogoCuentas")
			);
		$this->addAtt(
			array('key'=>"xmlns:catalogocuentas",'value'=>"www.sat.gob.mx/esquemas/ContabilidadE/1_1/CatalogoCuentas http://www.sat.gob.mx/esquemas/ContabilidadE/1_1/CatalogoCuentas/CatalogoCuentas_1_1.xsd")
			);
		$this->addAtt(
