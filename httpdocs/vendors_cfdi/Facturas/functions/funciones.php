...
function getKeyAndNumCert($rfc=''){
	global $cfg;
	if(isset($cfg['finkok_test_mode']) && $cfg['finkok_test_mode'] == 1)
	 	return array('pwd'=>'12345678a','cert'=>'20001000000200000181');

	if($rfc == 'IML121023RE5')
		return array('pwd'=>'SUR3548j','cert'=>'00001000000300905784');
	if($rfc == 'MOW1109201Y3')
		return array('pwd'=>'Intweb1109','cert'=>'00001000000300814115');
	if($rfc == 'TDS150924MR4')
