...
function showPartsList($arr_order_parts) {
    ...
    <table width="100%" align="center"  class="List">
        <tr class="tableListColumn">
            ...
            <td style="min-width: 7%;" align="center">Cant.</td>
            <td style="min-width: 7%;" align="center">Precio Vta.</td>
            <td style="min-width: 7%;" align="center">Desc.</td>
            <td style="min-width: 7%;" align="center">Env.</td>
            <td style="min-width: 7%;" align="center">Costo</td>
            <td style="min-width: 7%;" align="center">% Imp.</td>
            <td style="min-width: 7%;" align="center">Total</td>
