...
<div class="bar-header">
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0">
        <tbody>
            <tr>
                <td width="7px">
                    <img width="7px" height="100%" src="common/img/menubg1.png">
                </td>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0">
                        <tbody>
                            <tr>
                                ...
                                <td valign="middle" align="left"><img src="common/img/menubgdiv.png"></td>
                                ...
                                <td valign="middle" align="left">
                                    <img src="common/img/menubgdiv.png">
                                </td>
                                <td valign="middle" nowrap="" align="left">
                                    <font class="menu2">
                ...
                <td width="7px">
                    <img src="common/img/menubg3.png">
                </td>
            </tr>
        </tbody>
    </table>
