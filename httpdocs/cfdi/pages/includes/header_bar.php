...
<div class="bar-header">
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" id="top1">
        <tbody>
            <tr>
                <td width="230px"><a href="<?php echo $cfg['admin_url'] . $usr['application']; ?>/admin?cmd=home"><img border="0" src="/sitimages/app_bar/mod/direksys-logo.png"></a></td>
                <td align="left">
                    <font class="userinfo">  
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0">
        <tbody>
            <tr>
                <td width="7px">
                    <img width="7px" height="100%" src="/sitimages/app_bar/mod/menubg1.png">
                </td>
                <td width="100%" background="/sitimages/app_bar/mod/menubg2.png">
                    <table cellspacing="0" cellpadding="0" border="0">
                        <tbody>
                            <tr>
                                <td valign="middle" align="left"><font class="menu1" style="cursor: pointer;" onclick="location.href='/cfdi/index.php'">&nbsp;&nbsp;<img src="/sitimages/app_bar/mod/direksysRN.png" width=72px></font></td>
                ...
                <td width="7px">
                    <img src="/sitimages/app_bar/mod/menubg3.png">
                </td>
            </tr>
        </tbody>
    </table>
