...
<div class="bar-header">
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" id="top1">
        <tbody>
            <tr>
                <td width="230px"><a href="<?php echo $cfg['admin_url'] . $usr['application']; ?>/admin?cmd=home"><img border="0" src="common/img/direksys-logo.png"></a></td>
                <td align="left">
                    <font class="userinfo">  
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0">
        <tbody>
            <tr>
                ...
                <td width="100%" background="common/img/menubg2.png">
                    <table cellspacing="0" cellpadding="0" border="0">
                        <tbody>                            
                            <tr>
                                <td valign="middle" align="left"><font class="menu1" style="cursor: pointer;" onclick="location.href='/cfdi/index.php'">&nbsp;&nbsp;<?php echo $cfg['app_title_mod'] ?></font></td>
                                ...
                                <td valign="middle" nowrap="" align="left">
                                    <font class="menu2">
                                    <font class="modulo1"><span id="spn-mod-name"></span></font>&nbsp;
                                    </font>
                                </td>
                            </tr>
                        </tbody>
