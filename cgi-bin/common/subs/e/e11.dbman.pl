...
#############################################################################
#############################################################################
#   Function: loaddefault_ea_opr_orders
#
#       Es: Se oculta codigo de autorizacion para Ordenes nuevas
#       En: 
#
#
...
#      
#
sub loaddefault_ea_opr_orders{
#############################################################################
#############################################################################
	$va{'show_auth_code'} = 'display:none';
}
