...
A.buttonbig:hover		{
	...
	border: 1px solid #8ec012;text-decoration: none;
			...
			<img src="/sitimages/inside.png" style="width:100%;">
<br>
<table border=0 width=100% cellpadding=25px>
	<td> 

			<font class=texto>
				<font size=6><center>Ha accedido a Direksys</center></font><br>
				 <b>Todos los movimientos est&aacute;n siendo registrados</b> y cualquier actividad que no corresponda ser&aacute; notificada a las autoridades correspondientes. <br><br><br>
 <p align=right>
<a href="#" class="buttonbig" onclick="javascript:parent.jQuery.fancybox.close();">Entendido</a>
	</td>
</table> 