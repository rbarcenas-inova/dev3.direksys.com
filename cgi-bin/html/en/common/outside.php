...
A.buttonbig:hover		{
	...
	border: 1px solid #8ec012;text-decoration: none;
			...
			<img src="/sitimages/outside.png" style="width:100%;"><br> 

<table border=0 width=100% cellpadding=25px>
	<td> 

			<font class=texto>
			<font size=5>Acceso Remoto</font>
			<br><br>
			Ha accedido a direksys desde fuera de la red local. <b>Todos los movimientos están siendo registrados</b>
			 y cualquier actividad que no corresponda sera notificada a las autoridades.
			<br><br><br>
	 		<p align=right>
			<a href="#" class="buttonbig" onclick="parent.jQuery.fancybox.close();">Entendido</a>
			</p>
	</td>
</table> 